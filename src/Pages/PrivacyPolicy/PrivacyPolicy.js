    ...
    return(
        <>
            <div className="privacy-policy">
                ...
                <p><i class="fa fa-circle"></i> What types of cookies are used (e.g., session cookies, persistent cookies)</p>
                <p><i class="fa fa-circle"></i>The purpose of cookies (e.g., to enhance user experience, analyze site traffic)</p>
