        ...
        <>
            <div className="main-page-customer-support">
                <div className="customer-support">
                    ...
                    <br />
                    <h5>Thank you for being a part of the Crystal blog community! We appreciate your support and look forward to assisting you. Remember, your satisfaction is our top priority, and we are here to help you every step of the way.</h5>
                </div>
            </div>
        </>
    )
